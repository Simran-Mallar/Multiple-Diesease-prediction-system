# -*- coding: utf-8 -*-
"""
Created on Sat Oct  8 00:23:30 2022

@author: Simran Mallar
"""
...
diabetic_model = pickle.load(open('C:/Multiple diesease prediction system/diabetic_model.sav', 'rb'))

heart_disease_model = pickle.load(open('C:/Multiple diesease prediction system/heart_disease_model.sav','rb'))

parkinsons_model = pickle.load(open('C:/Multiple diesease prediction system/parkinsons_model.sav', 'rb'))
...
if (selected == 'Diabetes Prediction'):
    ...
    with col3:
        HDL_Chol = st.text_input('HDL Chol')
    ...
    if st.button('Diabetes Test Result'):
        diab_prediction = diabetic_model.predict([[Cholesterol,Glucose,HDL_Chol	,Age,Gender,Height,	Weight,	BMI,Systolic_BP	,Diastolic_BP]])
